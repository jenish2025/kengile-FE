  ...
  const positions = [
    {
      ...
      description:
        "Design and deploy scalable AI infrastructure, GPU clusters, and MLOps pipelines for enterprise clients. Work with cutting-edge technologies like NVIDIA A100, Ray, and Kubernetes.",
      href: "/contact-us",
      icon: <Brain size={32} />,
    ...
    },
    {
      ...
      description:
        "Architect hybrid cloud and HPC solutions, multi-cloud strategies, and enterprise cloud migrations. Lead design of scalable, resilient cloud infrastructure.",
      href: "/contact-us",
      icon: <Cloud size={32} />,
    ...
    },
    {
      ...
      description:
        "Build blockchain networks, smart contracts, and decentralized applications for enterprise use cases. Experience with Solidity and Web3 technologies required.",
      href: "/contact-us",
      icon: <Code size={32} />,
    ...
    },
    {
      ...
      description:
        "Implement CI/CD pipelines, Kubernetes clusters, and observability systems for modern IT operations. Strong experience with infrastructure as code.",
      href: "/contact-us",
      icon: <Zap size={32} />,
    ...
    },
    {
      ...
      description:
        "Build data pipelines, analytics platforms, and real-time streaming systems for AI and business intelligence. Experience with big data technologies required.",
      href: "/contact-us",
      icon: <Rocket size={32} />,
    ...
    },
    {
      ...
      description:
        "Ensure enterprise-grade security, compliance, and governance across cloud, blockchain, and AI systems. Experience with zero-trust architecture.",
      href: "/contact-us",
      icon: <Shield size={32} />,
  ...
  const benefits = [
    {
      ...
      description:
        "Industry-leading salaries, equity options, and annual performance bonuses. We reward excellence.",
    ...
    },
    {
      ...
      description:
        "Work from anywhere in the world. We have team members across 25+ countries with flexible hours.",
    ...
    },
    {
      ...
      description:
        "Comprehensive health insurance, mental health support, gym memberships, and wellness programs.",
    ...
    },
    {
      ...
      description:
        "$5,000 annual learning budget, conference tickets, certifications, and access to premium courses.",
    ...
    },
    {
      ...
      title: "Unlimited PTO",
      description:
        "Take the time you need to recharge. We believe in work-life balance and trust our team.",
    ...
    },
    {
      ...
      description:
        "MacBook Pro or high-end workstation, dual monitors, ergonomic setup, and any tools you need.",
    ...
    },
    {
      ...
      title: "Team Retreats",
      description:
        "Annual company retreats, quarterly team offsites, and regular virtual social events.",
    ...
    },
    {
      ...
      description:
        "Share in our success with competitive equity packages for all employees.",
  ...
  const values = [
    {
      ...
      description:
        "We encourage experimentation, embrace failure as learning, and constantly push technological boundaries.",
      color: "blue",
    },
    {
    ...
    },
    {
      ...
      title: "Impact-Driven",
      description:
        "Every project we undertake has the potential to transform industries and improve lives globally.",
      color: "green",
    },
    {
      ...
      description:
        "We set high standards for ourselves and deliver exceptional quality in everything we do.",
      color: "orange",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      quote:
        "Working at Kengile has been transformative for my career. I&apos;ve had the opportunity to work on cutting-edge AI infrastructure projects that are genuinely pushing the boundaries of what&apos;s possible. The team is brilliant, supportive, and the culture of innovation is real.",
      avatar: "SC",
    },
    {
      ...
      quote:
        "The remote-first culture at Kengile is authentic, not just a buzzword. I have the flexibility to work from anywhere while collaborating with talented engineers worldwide. The projects are challenging and the learning opportunities are endless.",
      avatar: "MR",
    },
    {
      name: "Jennifer Wu",
      ...
      quote:
        "I joined Kengile to work on meaningful blockchain projects, and I wasn&apos;t disappointed. We&apos;re building real enterprise solutions that solve actual problems. The team trusts you with autonomy while providing support when needed.",
      avatar: "JW",
    },
  ];
  ...
  const hiringProcess = [
    {
      ...
      description:
        "Submit your application through our careers portal. Our team reviews every application carefully.",
      duration: "2-3 days",
    },
    {
      step: "02",
      ...
      description:
        "A 30-minute video call with our recruiter to discuss your background, interests, and expectations.",
      duration: "30 minutes",
    },
    {
      step: "03",
      ...
      description:
        "Take-home assignment or live coding session relevant to the role. We respect your time with reasonable challenges.",
      duration: "2-4 hours",
    },
    {
      step: "04",
      ...
      description:
        "Meet with team members and hiring manager. Technical deep-dive, architecture discussions, and culture fit.",
      duration: "2-3 hours",
    },
    {
      step: "05",
      ...
      description:
        "Conversation with leadership about vision, growth opportunities, and alignment with company goals.",
      duration: "1 hour",
    },
    {
      step: "06",
      ...
      description:
        "Receive your offer, negotiate if needed, and join our comprehensive onboarding program.",
      duration: "1 week",
    },
  ];
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
              We&apos;re not just another tech company. We&apos;re building the
              infrastructure that will power the next generation of global
              enterprises.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-white/90 backdrop-blur-sm rounded-3xl p-10 border-2 border-blue-100 hover:border-blue-400 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
              >
                <div
                  className={`w-20 h-20 bg-gradient-to-br from-${value.color}-500 to-${value.color}-600 rounded-2xl flex items-center justify-center mb-6 text-white`}
                >
                  {value.icon}
                </div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {positions.map((position, index) => (
              <div
                key={index}
                className="bg-white rounded-3xl shadow-xl border-2 border-gray-100 hover:border-indigo-300 hover:shadow-2xl transition-all duration-500 overflow-hidden group"
              >
                <div className="p-8">
                  <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                    <div className="text-white">{position.icon}</div>
                  </div>
      ...
      <Section className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
              We believe in taking care of our team with world-class benefits
              and perks
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 border-2 border-purple-100 hover:border-purple-400 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 text-center"
              >
                <div
                  className={`w-20 h-20 bg-gradient-to-br ${benefit.gradient} rounded-2xl flex items-center justify-center mx-auto mb-6 text-white`}
                >
                  {benefit.icon}
                </div>
      ...
      <Section className="bg-white relative overflow-hidden">
        ...
        <div className="relative">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
              Hear directly from the people who make Kengile an amazing place to
              work
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 border-2 border-blue-100 hover:border-blue-400 hover:shadow-2xl transition-all duration-500"
              >
      ...
      <Section className="bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-50 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
              Transparent, respectful, and designed to help you showcase your
              best work
            </p>
          </div>
