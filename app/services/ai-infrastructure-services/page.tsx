      ...
      <Section className="bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-accent-700 mb-6">
            We design and deploy enterprise-grade AI infrastructure that scales
            with your machine learning workloads. From GPU clusters to
            distributed training systems, we provide the foundation for your AI
            initiatives.
          </p>
          <p className="text-lg text-accent-700 mb-8">
            Our services cover the entire AI infrastructure lifecycle , from
            initial setup and configuration to ongoing optimization and
            monitoring.
          </p>
        </div>
      </Section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white border border-accent-200 rounded-xl p-6 hover:border-primary-500 hover:shadow-lg transition-all">
            ...
            <p className="text-accent-600">
              Deploy and manage GPU clusters optimized for deep learning
              workloads. We configure NVIDIA, AMD, and cloud-based GPU solutions
          ...
          <div className="bg-white border border-accent-200 rounded-xl p-6 hover:border-primary-500 hover:shadow-lg transition-all">
            ...
            <p className="text-accent-600">
              Set up distributed training environments using frameworks like
              PyTorch, TensorFlow, and Horovod. Optimize for multi-node,
          ...
          <div className="bg-white border border-accent-200 rounded-xl p-6 hover:border-primary-500 hover:shadow-lg transition-all">
            ...
            <p className="text-accent-600">
              Build end-to-end MLOps pipelines for model training, versioning,
              deployment, and monitoring. Integrate with CI/CD systems for
          ...
          <div className="bg-white border border-accent-200 rounded-xl p-6 hover:border-primary-500 hover:shadow-lg transition-all">
            ...
            <p className="text-accent-600">
              Optimize AI workloads for speed, cost, and resource utilization.
              We analyze and tune your models and infrastructure for peak
              performance.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-subtle rounded-xl p-8">
              <h3 className="text-2xl font-semibold text-accent-900 mb-6">
                Technology Stack
              </h3>
      ...
      <Section className="bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-accent-600">
              How we deliver AI infrastructure solutions
            </p>
          </div>
          <div className="space-y-8">
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-accent-600">
                  We analyze your current infrastructure, AI workloads, and
                  requirements to design the optimal solution architecture.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-accent-600">
                  Deploy GPU clusters, configure networking, set up storage
                  systems, and implement security measures.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-accent-600">
                  Build automated pipelines for model training, testing,
                  deployment, and monitoring with CI/CD integration.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-accent-600">
                  Continuously optimize performance, monitor systems, and
                  provide ongoing support to ensure peak efficiency.
                </p>
              </div>
            </div>
          </div>
            ...
            items={[
              {
                ...
                answer:
                  "We support all major GPU types including NVIDIA A100, H100, V100, and RTX series, as well as AMD MI series and cloud-based GPU instances from AWS, Azure, and GCP.",
              },
              {
                question: "How long does it take to set up AI infrastructure?",
                answer:
                  "Typical setup time ranges from 2-4 weeks depending on complexity. Simple cloud-based setups can be completed in days, while large-scale on-premises deployments may take longer.",
              },
              {
                question: "Can you integrate with our existing infrastructure?",
                answer:
                  "Yes, we specialize in hybrid deployments that integrate seamlessly with your existing on-premises infrastructure, cloud environments, and data sources.",
              },
              {
                question: "What MLOps tools do you use?",
                answer:
                  "We work with industry-standard tools including MLflow, Kubeflow, Weights & Biases, TensorBoard, and custom solutions tailored to your specific needs.",
              },
              {
                question: "Do you provide ongoing support?",
                answer:
                  "Yes, we offer 24/7 monitoring, maintenance, and support packages to ensure your AI infrastructure runs smoothly and efficiently.",
              },
            ]}
          />
        </div>
      ...
      <Section className="bg-gradient-subtle">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-accent-600">
              Real-world success stories from our AI infrastructure projects
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <CaseStudyCard
