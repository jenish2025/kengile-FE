...
import { Building2, Factory, TrendingUp, Rocket, Shield, Zap, Check, ArrowRight, Users, Globe, Award, Cpu, Database, Lock, Cloud, Network, BarChart3, Workflow, Brain, LineChart, Boxes, Radio, CircuitBoard } from 'lucide-react';
...
export default function IndustriesWeServe() {
  const industries = [
    ...
    },
    {
      ...
      stats: { clients: '100+', projects: '500+', satisfaction: '98%' },
      capabilities: [
        'Cloud migration and optimization',
        'Enterprise data platform development',
        'Legacy system modernization',
        'AI/ML integration and adoption',
  ...
  const whyChooseUs = [
    {
      ...
      description: 'Our team includes former engineers from leading tech companies and domain experts with decades of experience',
      href: '/about-us',
    ...
    },
    {
      ...
      description: 'Successfully delivered 1000+ projects across multiple industries with an average client satisfaction of 98%',
    ...
    },
    {
      icon: <Globe size={40} />,
      title: 'Global Reach',
      description: 'Serving clients across 40+ countries with 24/7 support and localized solutions',
      href: '/contact-us',
    ...
    },
    {
      ...
      description: 'Early adopters of emerging technologies, helping clients stay ahead of the curve',
  ...
  const technologies = [
    { name: 'Cloud Platforms', icon: <Cloud className="w-6 h-6" />, tools: 'AWS, Azure, GCP, Kubernetes' },
    { name: 'AI & ML', icon: <Brain className="w-6 h-6" />, tools: 'TensorFlow, PyTorch, Hugging Face' },
    { name: 'Blockchain', icon: <Lock className="w-6 h-6" />, tools: 'Ethereum, Solana, Hyperledger' },
    { name: 'IoT', icon: <Network className="w-6 h-6" />, tools: 'MQTT, LoRaWAN, EdgeX' },
    { name: 'Data Analytics', icon: <BarChart3 className="w-6 h-6" />, tools: 'Apache Spark, Databricks, Snowflake' },
    { name: 'DevOps', icon: <Workflow className="w-6 h-6" />, tools: 'Docker, Jenkins, Terraform' }
  ];
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-blue-600 mb-2">295+</div>
              <div className="text-gray-600">Active Clients</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-purple-600 mb-2">1,355+</div>
              <div className="text-gray-600">Projects Delivered</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-pink-600 mb-2">98%</div>
      ...
      {/* Industries Section */}
      <section id="industries" className="py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="space-y-16">
            {industries.map((industry, index) => (
              <div key={industry.title} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow">
                <div className="grid md:grid-cols-2 gap-8 p-8 md:p-12">
                  <div>
                    <div className={`inline-flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-br ${industry.color} text-white mb-6`}>
                      {industry.icon}
                    </div>
                    <h3 className="text-3xl font-bold mb-4 text-gray-900">{industry.title}</h3>
                    ...
                    <div className="flex gap-6 mb-8">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-purple-600">{industry.stats.projects}</div>
                    ...
                    <h4 className="font-semibold text-lg mb-3 text-gray-900">Key Capabilities:</h4>
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6">
                    <h4 className="font-semibold text-lg mb-4 text-gray-900">Use Cases & Solutions:</h4>
                    ...
                    <a href="#contact" className={`mt-6 inline-flex items-center px-6 py-3 bg-gradient-to-r ${industry.color} text-white rounded-lg font-semibold hover:opacity-90 transition-opacity`}>
                      Learn More
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Technologies We Master</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Leveraging cutting-edge technologies to deliver innovative solutions across all industries
            </p>
          </div>
      ...
      <section id="contact" className="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Custom Solutions for Every Industry</h2>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="/case-studies" className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-semibold hover:bg-white/10 transition-all">
                View Case Studies
              </a>
            </div>
          </div>
